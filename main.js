document.addEventListener("DOMContentLoaded", function () {
    ...
    let partnerName = "Lokkhi"; // Replace with dynamic value
    ...
    yesButton.addEventListener("click", function () {
        questionText.innerHTML = `<span class="partner-name">${partnerName}</span><br><span class="love-text"> Love you babygurll ❤️</span>`;
    ...
    noButton.addEventListener("click", function () {
        ...
        if (noClickCount < 5) {
            ...
            questionText.innerHTML += `<br><span class="no-choice-text">Choice ache mone hoi ??? 🤭</span>`;
        }
    });
